# Generated by Django 2.0.6 on 2018-07-30 07:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(default='upload/avatar/default.png', upload_to='upload/avatar/%Y%m', verbose_name='头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(0, '草稿'), (1, '发布')], default=0)),
        ...
        migrations.AddField(
            model_name='posts',
            name='b_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.Type', verbose_name='博客类型'),
        ),
    ]
